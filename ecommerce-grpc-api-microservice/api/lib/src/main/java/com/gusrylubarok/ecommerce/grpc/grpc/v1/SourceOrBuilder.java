...
public interface SourceOrBuilder extends
   ...
   * @return The flow.
   */
  com.gusrylubarok.ecommerce.grpc.grpc.v1.Flow getFlow();
   ...
   * @return The owner.
   */
  com.gusrylubarok.ecommerce.grpc.grpc.v1.Owner getOwner();
  /**
   * <pre>
   * Information about the owner of the payment instrument that may be used or required by particular source types.
   * </pre>
   ...
   * <code>.com.gusrylmubarok.v1.Owner owner = 7;</code>
   */
  com.gusrylubarok.ecommerce.grpc.grpc.v1.OwnerOrBuilder getOwnerOrBuilder();
   ...
   * @return The receiver.
   */
  com.gusrylubarok.ecommerce.grpc.grpc.v1.Receiver getReceiver();
  /**
   * <pre>
   * Information related to the receiver flow. Present if the source is a receiver (flow is receiver).
   * </pre>
   ...
   * <code>.com.gusrylmubarok.v1.Receiver receiver = 8;</code>
   */
  com.gusrylubarok.ecommerce.grpc.grpc.v1.ReceiverOrBuilder getReceiverOrBuilder();
   ...
   * @return The status.
   */
  com.gusrylubarok.ecommerce.grpc.grpc.v1.Source.Status getStatus();
   ...
   * @return The usage.
   */
  com.gusrylubarok.ecommerce.grpc.grpc.v1.Usage getUsage();
}
