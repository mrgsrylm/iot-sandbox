...
public class MultiplicationServiceImplTest {
    ...
    public void checkCorrectAttemptTest() {
        ...
        given(userRepository.findByAlias("abdul_budi")).willReturn(Optional.empty());
    ...
    public void retrieveStatsTest() {
        ...
        given(userRepository.findByAlias("abdul_budi")).willReturn(Optional.empty());
        given(attemptRepository.findTop5ByUserAliasOrderByIdDesc("abdul_budi"))
                .willReturn(latestAttempts);

        // when
        List<MultiplicationResultAttempt> latestAttemptsResult =
                multiplicationServiceImpl.getStatsForUser("abdul_budi");
