...
import com.gusrylmubarok.mca.gamification.game.badgeprocessors.FirstWonBadgeProcessor;
...
class FirstWonBadgeProcessorTests {
    ...
    public void shouldNotGiveBadgeIfNotFirstTime() {
        Optional<BadgeType> badgeType = badgeProcessor
                .processForOptionalBadge(20, List.of(new ScoreCard(1L, 1L),
